...
object HospitalChargesAnalysis extends App {
  ...
  val dataFrame = spark.read.option("header", true).option("inferSchema", true).csv("/Users/p5103951/IdeaProjects/SparkMachineLearningRef/src/main/resources/inpatientCharges.csv")
  //dataFrame.show(5)
